...
namespace Game1
{
    class FireLeftFlagState : IMarioState
    {
        IMario container;
        ...
        public FireLeftFlagState(IMario mario)
        {
            container = mario;
            character = MarioFactory.fireMarioLeftFlagAtlas;
        ...
        {
            //throw new NotImplementedException();
            return MarioFactory.Instance.CreateFireLeftFlagState(destination);
        }
