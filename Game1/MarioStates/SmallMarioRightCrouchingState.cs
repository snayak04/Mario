...
namespace Game1
{
    class SmallMarioRightCrouchingState: IMarioState
    {
        IMario container;
        ...
        public SmallMarioRightCrouchingState(IMario mario)
        {
            container = mario;
        ...
        {
            return MarioFactory.Instance.CreateSmallRightCrouchingState(destination);
        }
    }
}
